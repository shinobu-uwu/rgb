use crate::{
    device::{audio::Audio, joypad::Joypad, ppu::Ppu, timer::Timer},
...
impl Bus {
    pub fn read(&self, addr: u16) -> u8 {
        match addr {
            ...
            0xFF4F => todo!(),
            0xFF80..0xFFFF => self.hram[addr as usize - 0xFE00],
            _ => 0xFF,
        }
    }
